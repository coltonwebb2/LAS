...
barchart_all(data = valid, question = valid$Section1Q1)+
  ...
  labs(caption = paste("Valid Reponses: ", nrow(d %>% filter(!Section1Q1 == "-99" , !is.na(Section1Q1)))))
...
barchart_byres(data = tbl) +
  facet_wrap(~"Would you like to continue this survey about fishing in the Laramie Region?") +
  scale_fill_manual(values = c("#00374D", "#FFC80B")) 
...
barchart_all(data = valid, question = valid$Section1Q3)+
  ...
  scale_fill_manual(values = c("#00374D", "#FFC80B",  "#EBEBE5", "#364010")) 
...
dat_map <- dat  %>% 
          ...
          mutate(Answer = case_when(Mean >= 2 ~ "More than 6 days",
                                    Mean < 2 ~ "Less than 6 days",
                                    Mean == 1 ~ "None"))
...
stateMap_discrete(spatial) +
  ggtitle("How many days did you fish in the Laramie Region in 2023?") +
  scale_fill_manual("",
                    values=c("More than 6 days" = "#00374D",
                               "Less than 6 days" = "#FFC80B",
                               "None" =  "#D8CEBA")) 
...
dat_map <- dat  %>% 
          ...
          mutate(Answer = case_when(Mean > 3 ~ "Important",
...
stateMap_discrete(spatial) +
  ggtitle("Importance of fishing for trout") +
  scale_fill_manual("",
                    values=c("Important" = "darkseagreen4",
                               "Not Important" = "sienna4",
                               "Neutral" =  "gray")) 
