...
- Of the the Non-Resident License (residency = Non Resident, feetype = NFA) there are 73 that have WY as their residence state, but listed a non-resident license type
...
uszip <- data.frame(read.csv(paste0(myPath,"/Data/uszip.csv"))) %>% 
          rename(zipcode = zip) %>% 
